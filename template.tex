...
\begin{figure*}[!ht]
	\centering
	\subfloat[Trapezoidal Rule \cite{euler}]{\includegraphics[width=0.4\textwidth]{TrapezoidalStability.png}%
		\label{fig:trapezoidal}}
	\hfil
	\subfloat[Implicit Euler Method \cite{trapezoidal}]{\includegraphics[width=0.4\textwidth]{EulerStability.png}%
		\label{fig:euler}}
...
Most of the content of this paper (and the mathematical notation) is from \cite{leveque}. The code used to produce the plots is original work and can be found in \cite{github}. We chose Julia to show the features of the language. Code inspired by \cite {clawpack} and \cite {riemann}.
