...
The code used to produce the plots is original work (unless differently credited) and can be found in \cite{github}. We chose Julia to show the features of the language. Code inspired by \cite {clawpack} and \cite {riemann}.
